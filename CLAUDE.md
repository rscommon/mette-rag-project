...
The dataset is in Danish. When building prompts, retrieval queries, or UI text that interacts with this data, default to Danish unless otherwise specified. So this is a change. Change
